# We have commented out all resources that are managed externally by Cloud Run.
# We are using the existing resources and IAM bindings for saving time.

# Cloud Run API Service - Now managed externally, referenced via data block
...
# IAM bindings for the service account - Now managed externally
...
# IAM policy for Cloud Run service - Now managed externally
...
# Cloud Run Domain Mapping for custom domain - Now managed externally
# resource "google_cloud_run_domain_mapping" "api_domain" {
#   location = google_cloud_run_v2_service.api.location
#   name     = "rainbow-api.tuantrann.work"
...
# Reference existing domain mapping (if it exists)
# data "google_cloud_run_domain_mapping" "api_domain" {
#   location = local.cloud_run_region
#   name     = "rainbow-api.tuantrann.work"
# }

# VPC Access Connector for Cloud Run - Now managed externally, referenced via data block
